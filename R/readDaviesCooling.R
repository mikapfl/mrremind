...
readDaviesCooling <- function(subtype) {
  ...
  regions <- c("USA" = "USA", "Canada" = "CAN", "Western Europe" = "WEU", "Japan" = "JPN", "Australia & NZ" = "ANZ", "Former Soviet Union" = "FSU", "China" = "CHN", "Middle East" = "MEA", "Africa" = "AFR", "Latin America" = "LAM", "Southeast Asia" = "SEA", "Eastern Europe" = "EEU", "Korea" = "KOR", "India" = "IND")
