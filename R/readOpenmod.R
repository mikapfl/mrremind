...
#'
 ...
 readOpenmod <- function() {
   ...
   data2010 <- melt(data2010, id.vars = c("dummy", "period"), variable.name = "tech", value.name = "value")  # data in wide format. melt requires library(reshape2)
   ...
   data2015 <- melt(data2015, id.vars = c("dummy", "period"), variable.name = "tech", value.name = "value")  # data in wide format. melt requires library(reshape2)
   # data
