...
calcJRC_IDEES <- function(subtype) {
  ...
  if (subtype == "Industry") {
    ...
    mapping <- toolGetMapping("Mapping_JRC_IDEES_REMIND_Industry.csv", type = "reportingVariables")
    ...
    mapping <- toolGetMapping("Mapping_JRC_IDEES_REMIND_Transport.csv", type = "reportingVariables")
  } else {
    ...
    mapping <- toolGetMapping("Mapping_JRC_IDEES_REMIND_ResCom.csv", type = "reportingVariables")
  }
